...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/dotnet-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dotnet-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add dotnet dotnet-aspnetcore dotnet-desktop dotnet-runtime dotnet-sdk
# for installing globally
pixi global install dotnet dotnet-aspnetcore dotnet-desktop dotnet-runtime dotnet-sdk
```
...
It is possible to list all of the versions of `dotnet` available on your platform:
...
```
pixi search dotnet --channel conda-forge
```
